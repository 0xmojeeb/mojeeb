      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          {coreSkills.map((skill, i) => (
            <div key={i} className="bg-[#0a0a0a] border border-white/10 p-10 rounded-[2.5rem] group hover:border-[#7c3aed]/50 transition-all">
              <div className="text-[#7c3aed] mb-6 bg-[#7c3aed]/10 w-fit p-4 rounded-2xl group-hover:scale-110 transition-transform">
                {skill.icon}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          <div className="md:col-span-8 bg-[#0a0a0a] border border-white/10 p-10 rounded-[2.5rem] flex items-center gap-8 group">
            <div className="bg-[#7c3aed]/10 p-4 rounded-2xl text-[#7c3aed] hidden md:block">
          ...
          <div className="md:col-span-4 bg-[#7c3aed] p-10 rounded-[2.5rem] flex flex-col justify-between hover:shadow-[0_0_30px_rgba(124,58,237,0.4)] transition-all">
