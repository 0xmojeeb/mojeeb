      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="bg-[#4e24cf] rounded-[2rem] p-10 md:p-14 mb-6 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div>
              <p className="text-white/50 text-[10px] font-black uppercase tracking-[0.4em] mb-3">Available for Work</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
          ...
          <div className="md:col-span-5 bg-[#080808] border border-white/[0.06] rounded-[1.75rem] p-8 flex flex-col justify-between">
            <p className="text-[9px] font-black text-[#4e24cf] uppercase tracking-[0.4em] mb-6">What I Do</p>
            ...
            <div className="mt-6 pt-6 border-t border-white/[0.05] flex items-center justify-between">
              <div>
                <p className="text-[8px] text-white/20 uppercase tracking-widest font-bold mb-1">Availability</p>
                <p className="text-[#4e24cf] font-black text-sm uppercase tracking-tight">Open for Q1 '26</p>
              </div>
