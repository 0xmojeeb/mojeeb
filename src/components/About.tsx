...
const About = () => {
  const ecosystems = [
    { name: "ETHEREUM", logo: "https://ethereum.org/static/6b935ac2290d300300d9d13e39644ba2/6ed5c/eth-diamond-black.png" },
    ...
    { name: "POLYGON", logo: "https://raw.githubusercontent.com/maticnetwork/polygon-tokens/main/lib/logos/polygon.png" },
    { name: "AVALANCHE", logo: "https://raw.githubusercontent.com/avax-nodes/avalanche-logos/main/logo-mark/avalanche-logo-mark.png" },
  ];
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-between items-end">
              ...
              <div className="w-full md:w-auto flex flex-col gap-4 items-end">
                 ...
                 <div className="flex gap-3">
                    <a href="https://blindspotlab.xyz/audit" target="_blank" className="bg-white/5 hover:bg-[#4e24cf]/20 p-3 rounded-xl transition-colors border border-white/10 group">
